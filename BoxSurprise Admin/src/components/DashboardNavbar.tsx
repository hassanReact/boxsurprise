  ...
  return (
    <header className="bg-white shadow-md h-16 flex items-center justify-between px-4 md:px-6 fixed top-0 right-0 left-0 z-30 lg:left-64 transition-all duration-300">
      <div className="flex items-center">
        ...
        <div className="text-base md:text-xl font-semibold text-gray-800 truncate">Welcome back, John!</div>
      </div>
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        <div className="relative" ref={profileRef}>
          <div 
            className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-indigo-100 flex items-center justify-center cursor-pointer"
            onClick={() => {
